...
<div class="modal-primary mr-1 mb-1 d-inline-block">
        <!-- Modal -->
        <div class="modal fade text-left" id="more_info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                   ...
                   <form action="{{route('update_more_info')}}" method="post">
                      @csrf
                      <input type="hidden" name="about_id" value="{{$data->about_id}}">
                        ...
                        <div class="col-md-12 col-12">
                          <div class="form-label-group position-relative has-icon-left">
                            <input type="text" class="form-control lm-input-text title" name="title" value="{{$data->about_title}}" placeholder="Title">
                            <h6 class="title-error error_message">Enter message</h6>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-label-group position-relative has-icon-left">
                            <textarea class="form-control message" id="basicTextarea" rows="4" placeholder="Slider Description" name="des">{{$data->about_des}}</textarea>
